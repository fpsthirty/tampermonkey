...
#### 📜 Avito helper
**Код скрипта:**   [avito-helper.js](https://github.com/fpsthirty/tampermonkey/blob/main/scripts/avito/avito-helper.js)<br>
**Описание:** Упрощает взаимодействие с объявлениями путём подсветки важных характеристик объявления (пользователь задаёт их сам), а также сбор прочей полезной информации об объявлении на боковом меню.<p>

**Функции:**
- Раздел недвижимости: 
  - копирование адреса объекта в один клик;
  - копирование ссылки объявления в один клик;
  - взаимодействие с важными характеристики объекта, по которым нельзя задать фильтры через стандартный поисковик объявлений.

**Поддерживаемые страницы:** `https://avito.ru/*`<br>
